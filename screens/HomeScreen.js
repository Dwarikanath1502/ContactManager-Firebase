...
export default class HomeScreen extends React.Component {
  ...
  getAllContact = () => {
    ...
    constctRef.on("value", dataSnapsot =>{
      if (datasnapsot.val()) {
        let constactResult = Object.values(dataSnapsot.val());
        let contactKey = Object.keys(dataSnapsot.val() )
        contactKey.forEach((value , key)=>{
          conatctResult[key]["key"] = value;
        });

 //TODO: sort array by fname and set it to data state
    self.setState({
      data: conatctResult.sort((a , b)=>{
